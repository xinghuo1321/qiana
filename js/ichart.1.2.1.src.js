...
$.Painter = $.extend($.Element, {
	...
	configure : function() {
		...
		this.set({
			...
			/**
			 * @cfg {String} Specifies the font's color for this element.(defaults to 'black') wufeng外容器padding值
			 */
			color : 'black',
			/**
...
$.Component = $.extend($.Painter, {
	configure : function(c) {
		...
		this.set({
			...
			color : '#a4a4a4',
			/**
			 * @cfg {String} Specifies the font of this element.(default to 'Verdana')  wufeng 字体大小
			 */
			font : 'Verdana',
			/**
...
$.Column = $.extend($.Chart, {
	...
	configure : function(config) {
		...
		this.set({
			...
			column_width : '25%',
			/**
			 * @cfg {Number} the space of each column.this option is readOnly.(default to undefined) wufeng柱形大小
			 */
			...
			this.set({
				 ...
				 */
				 ...
				 /**
					 ...
					 */
				 style:'textAlign:left;padding:0 15px;border-radius:15px;cursor:pointer;backgroundColor:#ff0000;fontSize:14px;color:#fff;',
				 /**
